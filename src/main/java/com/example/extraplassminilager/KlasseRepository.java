...
public class KlasseRepository {
    ...
    public List<Klasse> getKlasserFraDatabase() {
    ...
    public List<Klasse> populerklasser(Map<Integer, List<Integer>> bodklasser, List<Integer> erOpptatt) {
        List<Klasse> klasser = getKlasserFraDatabase();
        ...
        for (Klasse klasse : klasser) {
            ...
            for (int bodNr : bodklasser.get(klasse.getNr())) {
                ...
                klasse.addBoder(new Bod(bodNr, klasse.getNr(), etasje));
                klasse.incAntallBoder();
            }
    ...
    // Sender lise med klasse-objekter
    public List<Klasse> getKlasser(Map<Integer, List<Integer>> bodKlasser, List<Integer> opptatt) {
        return populerklasser(bodKlasser, opptatt);
    }
}
